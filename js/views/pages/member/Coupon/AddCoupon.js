...
class CouponAdd extends ScreenComponent {
    ...
    _doSubmit(status) {
        ...
        let merchant_ids = this.state.mid;
        ...
        return (
            <div className='cell -right-line coupon-wrap'>
                ...
                <div className='cell-item'>
                    ...
                    <div className='-value' style={this.state.scope_name ? { color: '#000' } : {}}><input ref='publish_num' type='text' placeholder='输入发行数量' /></div>
                </div>
